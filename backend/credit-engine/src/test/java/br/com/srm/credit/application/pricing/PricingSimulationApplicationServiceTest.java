...
class PricingSimulationApplicationServiceTest {
    ...
    private final ExchangeRateQueryService exchangeRateQueryService = mock(ExchangeRateQueryService.class);
    ...
    void shouldSimulateCommercialReceivablePricing() {
        var command = new PricingSimulationCommand(
                "OP-001", "TRADE_RECEIVABLE", "BRL", "BRL", new BigDecimal("1000.00"), new BigDecimal("0.0200"), 30);
